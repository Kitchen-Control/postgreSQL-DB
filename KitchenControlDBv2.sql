...
('admin001', '$2a$10$hashedpassword1', 'Nguyễn Quản Trị', 1, NULL),          -- Admin
('manager001', '$2a$10$hashedpassword2', 'Trần Giám Đốc', 2, NULL),          -- Manager
('store_q1', '$2a$10$hashedpassword3', 'Lê Nhân Viên Q1', 3, 1),             -- Store Q1 (unique)
('store_q7', '$2a$10$hashedpassword4', 'Phạm Thị Lan', 3, 2),                -- Store Q7 (unique)
('coordinator01', '$2a$10$hashedpassword5', 'Võ Điều Phối', 4, NULL),        -- Coordinator
('warehouse01', '$2a$10$hashedpassword6', 'Đặng Thủ Kho', 5, NULL),          -- Warehouse Keeper
('shipper01', '$2a$10$hashedpassword7', 'Hoàng Tài Xế 1', 6, NULL),          -- Shipper 1
('shipper02', '$2a$10$hashedpassword8', 'Bùi Tài Xế 2', 6, NULL),            -- Shipper 2
('kitchen01', '$2a$10$hashedpassword9', 'Ngô Đầu Bếp', 7, NULL);             -- Kitchen Staff
